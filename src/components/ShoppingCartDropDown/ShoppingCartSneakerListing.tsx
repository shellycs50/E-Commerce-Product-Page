...
function ShoppingCartSneakerListing({ bagCount, setBagCount }: { bagCount: number, setBagCount: React.Dispatch<React.SetStateAction<number>>}) {
    ...
    return (
        <div className="flex flex-col w-full p-3 justify-start gap-6 h-full items-center text-darkgrayishblue">
...
export default ShoppingCartSneakerListing